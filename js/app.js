...
var icon = document.getElementById("birthHamburger"),
    ...
    hambg = document.getElementsByClassName("hamBurgerIcon");
...
// $('.navbar-menuWrap').on("click", function () {
//     $('#birthHamburger').click();
//     // console.log('Clicked')
// });

// $('.navbar-menuWrap').hover(function () {
//     // $('.SM-showMenu').remove();
//     $('#birthHamburger').click();
//     // console.log('Clicked')
// });
...
function initOciliator(remove) {
    ...
    if (!remove) {
        ...
        function loop() {
            ...
            // ctx.strokeStyle = 'hsla(336, 100%, 56%,0.25)';
            ctx.strokeStyle = 'hsla(180, 100%, 50%,0.25)';
            ctx.lineWidth = 1;
            ...
            if (color == 1) {
                ...
                // ctx.strokeStyle = 'hsla(257, 90%, 44%,0.25)';
                // ctx.strokeStyle = 'hsla(342, 66%, 40%,0.25)';
            }
...
window.addEventListener("scroll", function () {
    ...
    homeSection.style.transform = `translate3d(0, ${-currScrollPos / 5
...
window.addEventListener("scroll", function () {
    ...
    skillSection.style.opacity = -currScrollPos3 / 2100 + 1.7;
...
window.addEventListener("scroll", function () {
    ...
    proSection.style.opacity = -currScrollPos1 / 2900 + 1.7;
    // proSection.style.transform = `translate3d(0, ${-currScrollPos1 / 5
    //     }px, 0) skew(0deg, ${currScrollPos1 / 60}deg)`;
});
...
window.addEventListener("scroll", function () {
    ...
    conSection.style.opacity = -currScrollPos4 / 7200 + 1.7;
    // proSection.style.transform = `translate3d(0, ${-currScrollPos1 / 5
    //     }px, 0) skew(0deg, ${currScrollPos1 / 60}deg)`;
});
...
//Aw Section
const AwSection = document.querySelector("#award-section");
window.addEventListener("scroll", function () {
    let currScrollPos5 = window.pageYOffset;
    AwSection.style.opacity = -currScrollPos5 / 6200 + 1.7;
    // proSection.style.transform = `translate3d(0, ${-currScrollPos1 / 5
    //     }px, 0) skew(0deg, ${currScrollPos1 / 60}deg)`;
});
function projectTitleAnimationac() {
    let sectionList = document.querySelectorAll(".popo");
    let section = document.querySelector("#award-section-title");
    sectionList.forEach(function (sectionL) {
        if (isVisible(section, -0) === true) {
            sectionL.classList.remove("hiddenac");
        }
        if (isVisible(section) === false) {
            sectionL.classList.add("hiddenac");
        }
    });
}
document.addEventListener("scroll", projectTitleAnimationac);
